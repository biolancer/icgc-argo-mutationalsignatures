...
def sigpro_func(sample, filetype, output_pattern, ref, exome, context, cosmic_version, exclude_sigs):
    sig.cosmic_fit(samples=sample, output=output_pattern, input_type=filetype, genome_build=ref, exome=exome, context_type=context, cosmic_version=cosmic_version, exclude_signature_subgroups=exclude_sigs)
